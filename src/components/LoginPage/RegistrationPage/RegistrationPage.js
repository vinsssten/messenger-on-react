...
function RegistrationPage({ isRegisterPageActive, setIsRegisterPageActive }) {
    ...
    function registerClick(event) {
        ...
        if (
            !validator.isEmpty(username, userParams) &&
        ...
        <div className="login_MainContainer">
            <div className="login_Container">
                <div className="login_ContentContainer">
                    ...
                    <div className="login_SubmitButton" onClick={registerClick}>
                        Sign Up
                    </div>
                    <h4 className="login-TextAdditional" style={{ cursor: 'default' }}>
                        All fields must be filled in, and the password cannot be shorter
                        than 4 characters, and longer than 16
                    </h4>
                    <h4
